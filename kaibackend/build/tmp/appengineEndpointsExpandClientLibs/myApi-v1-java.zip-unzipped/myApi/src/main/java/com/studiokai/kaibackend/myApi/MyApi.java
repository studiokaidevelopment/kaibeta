 ...
 * on 2017-06-19 at 22:49:37 UTC 
 * Modify at your own risk.
 */

package com.studiokai.kaibackend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class SayHi extends MyApiRequest<com.studiokai.kaibackend.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, com.studiokai.kaibackend.myApi.model.MyBean.class);
   ...
   * @return the request
   */
  public Test test(java.lang.String minDate, java.lang.String maxDate) throws java.io.IOException {
    Test result = new Test(minDate, maxDate);
    initialize(result);
    return result;
  }

  public class Test extends MyApiRequest<com.studiokai.kaibackend.myApi.model.MyBean> {

    private static final String REST_PATH = "test/{minDate}/{maxDate}";
     ...
     * @since 1.13
     */
    protected Test(java.lang.String minDate, java.lang.String maxDate) {
      super(MyApi.this, "POST", REST_PATH, null, com.studiokai.kaibackend.myApi.model.MyBean.class);
    ...
    public Test setMinDate(java.lang.String minDate) {
    ...
    public Test setMaxDate(java.lang.String maxDate) {
